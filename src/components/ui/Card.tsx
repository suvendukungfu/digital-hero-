...
>(({ className, variant = "default", ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-white/5 bg-card text-card-foreground shadow-sm overflow-hidden",
      variant === "glass" && "bg-card/40 backdrop-blur-xl border border-white/10 shadow-2xl",
      className
    )}
    {...props}
  />
